	...
	<div class="topbar d-flex align-items-center">
		<nav class="navbar navbar-expand">
			<div class="topbar-logo-header">
				<div class="">
					<img src="../../assets/img/logo_Kho_Nhap-removebg-preview.png" class="logo-icon" alt="logo icon">
				</div>
				<div class="">
					<h4 class="logo-text">Công ty ABC</h4>
				</div>
			</div>
			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
					...
					<img src="/../src/assets/img/logo_Kho_Nhap-removebg-preview.png" class="user-img" alt="user avatar">
					<div class="user-info ps-3">
						<p class="user-name mb-0">HỆ THỐNG QUẢN LÝ KHO AI</p>
